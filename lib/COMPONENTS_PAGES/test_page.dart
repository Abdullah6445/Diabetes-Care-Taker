...
class diabetesTestTablePage extends StatefulWidget {
  const diabetesTestTablePage({super.key});

  @override
  State<diabetesTestTablePage> createState() => _diabetesTestTablePageState();
}

class _diabetesTestTablePageState extends State<diabetesTestTablePage> {
  @override
